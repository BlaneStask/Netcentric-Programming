    ...
    $('#submitZipCode').click(function(){
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#card_current_temp").html("Temperature: " + response.main.temp + "°F");
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    for(let i = 1; i <= 5; i++){
                        ...
                        $("#card" + i + "_day_temp").html("Temperature: " + response.daily[i - 1].temp.day + "°F");
                        $("#card" + i + "_minmax_temp").html("Max Temperature: " + response.daily[i-1].temp.max + "°F" +"<br>"+  "Min Temperature: " + response.daily[i-1].temp.min + "°F");
